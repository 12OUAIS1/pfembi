...
import {
  ...
  getSharedManager,
  qsa
} from "./chunk-NSETGVAI.js";
import {
  usePrevious
} from "./chunk-H7EP6YFU.js";
import {
  Button_default as Button_default2
} from "./chunk-TM7VWB44.js";
import {
  Button_default
} from "./chunk-PLE3SLQW.js";
import {
  ...
  usePopper_default
} from "./chunk-5BS3XKTH.js";
import {
  require_browser,
  useTimeout,
  useUncontrolled
} from "./chunk-T2QTJ7PK.js";
import {
  Tooltip_default
} from "./chunk-LFR7TEWG.js";
import {
  Fade_default,
  NoopTransition_default,
  useWindow
} from "./chunk-UN2OV6VC.js";
import {
  ENTERED,
  ENTERING,
  EXITED,
...
} from "./chunk-F6DUBCJK.js";
import "./chunk-VWUFDFEG.js";
import {
  DEFAULT_BREAKPOINTS,
...
var Feedback = React54.forwardRef(
  ...
  ({
    ...
    tooltip = false,
    ...props
  }, ref) => (0, import_jsx_runtime49.jsx)(Component, {
    ...props,
    ref,
...
var FormControl = React59.forwardRef(({
  ...
  return (0, import_jsx_runtime55.jsx)(Component, {
    ...
    readOnly,
    id: id || controlId,
    className: (0, import_classnames44.default)(className, plaintext ? `${bsPrefix}-plaintext` : bsPrefix, size && `${bsPrefix}-${size}`, type === "color" && `${bsPrefix}-color`, isValid && "is-valid", isInvalid && "is-invalid")
  });
});
...
var FormSelect = React64.forwardRef(({
  ...
  return (0, import_jsx_runtime60.jsx)("select", {
    ...
    size: htmlSize,
    ref,
    className: (0, import_classnames48.default)(className, bsPrefix, size && `${bsPrefix}-${size}`, isValid && `is-valid`, isInvalid && `is-invalid`),
    id: id || controlId
  });
});
...
var Switch = React66.forwardRef((props, ref) => (0, import_jsx_runtime62.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var Form = React68.forwardRef(({
  ...
  as: Component = "form",
  ...props
}, ref) => (0, import_jsx_runtime65.jsx)(Component, {
  ...props,
  ref,
...
var InputGroup = React70.forwardRef(({
  ...
  return (0, import_jsx_runtime67.jsx)(InputGroupContext_default.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime67.jsx)(Component, {
      ref,
      ...props,
      className: (0, import_classnames53.default)(className, bsPrefix, size && `${bsPrefix}-${size}`, hasValidation && "has-validation")
    })
  });
});
...
var NavItem = React72.forwardRef((_ref, ref) => {
  ...
  return (0, import_jsx_runtime68.jsx)(Component, Object.assign({}, options, props, {
    ref
  }));
});
...
var Nav = React73.forwardRef((_ref, ref) => {
  ...
  return (0, import_jsx_runtime69.jsx)(SelectableContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime69.jsx)(NavContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime69.jsx)(Component, Object.assign({}, props, {
...
var NavItem2 = React76.forwardRef(({
  className,
  bsPrefix,
  as: Component = "div",
  ...props
...
var Nav2 = React78.forwardRef((uncontrolledProps, ref) => {
  ...
  let isNavbar = false;
  const navbarContext = (0, import_react30.useContext)(NavbarContext_default);
  const cardHeaderContext = (0, import_react30.useContext)(CardHeaderContext_default);
  if (navbarContext) {
...
var NavbarCollapse = React80.forwardRef(({
  ...
  const context6 = (0, import_react31.useContext)(NavbarContext_default);
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = (0, import_react33.useState)(() => mql ? mql.matches : false);
  useIsomorphicEffect_default(() => {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react34.useMemo)(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
var OffcanvasBody = React82.forwardRef(({
  className,
  bsPrefix,
  as: Component = "div",
  ...props
...
var OffcanvasTitle = React85.forwardRef(({
  className,
  bsPrefix,
...
var Offcanvas = React86.forwardRef(({
  ...
  const modalManager = (0, import_react35.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const {
    onToggle
  } = (0, import_react35.useContext)(NavbarContext_default) || {};
  const [showOffcanvas, setShowOffcanvas] = (0, import_react35.useState)(false);
  ...
  const renderBackdrop = (0, import_react35.useCallback)((backdropProps) => (0, import_jsx_runtime82.jsx)("div", {
    ...backdropProps,
...
var NavbarText = React88.forwardRef(({
  className,
  bsPrefix,
  as: Component = "span",
  ...props
...
var Navbar = React89.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime87.jsx)(NavbarContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime87.jsx)(SelectableContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime87.jsx)(Component, {
        ref,
        ...controlledProps,
...
var PageItem = React91.forwardRef(({
  ...
  return (0, import_jsx_runtime90.jsx)("li", {
    ...
    children: (0, import_jsx_runtime91.jsxs)(Component, {
...
var Row = React97.forwardRef(({
  ...
  return (0, import_jsx_runtime97.jsx)(Component, {
    ref,
    ...props,
...
var Spinner = React98.forwardRef(({
  ...
  return (0, import_jsx_runtime98.jsx)(Component, {
    ref,
    ...props,
    className: (0, import_classnames75.default)(className, bsSpinnerPrefix, size && `${bsSpinnerPrefix}-${size}`, variant && `text-${variant}`)
  });
});
...
function useTabPanel(_ref) {
  ...
  const context6 = (0, import_react39.useContext)(TabContext_default);
  if (!context6)
    ...
    return (0, import_jsx_runtime102.jsx)(TabContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime102.jsx)(SelectableContext_default.Provider, {
        ...
        children: (0, import_jsx_runtime102.jsx)(Transition, {
          ...
          mountOnEnter,
          unmountOnExit,
          children: (0, import_jsx_runtime102.jsx)(Component, Object.assign({}, tabPanelProps, {
            ref,
            hidden: !isActive,
...
var Table = React106.forwardRef(({
  ...
  const classes = (0, import_classnames79.default)(className, decoratedBsPrefix, variant && `${decoratedBsPrefix}-${variant}`, size && `${decoratedBsPrefix}-${size}`, striped && `${decoratedBsPrefix}-${typeof striped === "string" ? `striped-${striped}` : "striped"}`, bordered && `${decoratedBsPrefix}-bordered`, borderless && `${decoratedBsPrefix}-borderless`, hover && `${decoratedBsPrefix}-hover`);
...
var ToastFade = React108.forwardRef((props, ref) => (0, import_jsx_runtime110.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React110.forwardRef(({
  ...
  const context6 = (0, import_react41.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
...
var ToastBody = React111.forwardRef(({
  ...
  return (0, import_jsx_runtime113.jsx)(Component, {
    ref,
